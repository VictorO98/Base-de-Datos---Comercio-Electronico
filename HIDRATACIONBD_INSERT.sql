...
EXEC    INSERTCATA  (   1   ,'02-02-1998'   ,'02-12-2021'   );
EXEC    INSERTCATA  (   2   ,'02-02-2010'  ,'02-12-2021'   );
EXEC    INSERTCATA  (   3   ,'02-02-190'   ,'02-02-1998'   );

EXEC    INSERTPRODUCTOS (   1   ,'MARTILLO' ,'MARTILLO PARA MARTILLAR'  ,   14  ,   1   ,   1   ,   200, 150 );
EXEC    INSERTPRODUCTOS (   2   ,'TIJERAS'  ,'PARA CORTAR'  ,   14  ,   2   ,   1   ,   200 , 150);
EXEC    INSERTPRODUCTOS (   3   ,'DIAMENTE' ,'MATERIAL EXOTICO' ,   1457    ,   3   ,   1   ,   200 , 150);
EXEC    INSERTPRODUCTOS (   4   ,'REDSTONE' , 'PARA CIRCUITOS'  ,   14  ,   3   ,   1   ,   5   , 150);
EXEC    INSERTPRODUCTOS (   5   ,'REPETIDORES'  , 'REPITEN' ,   14  ,   3   ,   1   ,   200 , 150);
EXEC    INSERTPRODUCTOS (   6   ,'PC'   , 'PARA JUGAR MAINCRA'  ,   14  ,   2   ,   1   ,   200 , 150);
EXEC    INSERTPRODUCTOS (   7   ,'ZOMBIE'   , 'MATARLOS'    ,   14  ,   2   ,   1   ,   10  , 150);


EXEC    INSERTPRODCATA  (   1   ,    100 ,   3   ,   1   );
EXEC    INSERTPRODCATA  (   2   ,    100 ,   2   ,   2   );
EXEC    INSERTPRODCATA  (   3   ,    100 ,   1   ,   3   );
EXEC    INSERTPRODCATA  (   4   ,    100 ,   2   ,   4   );
EXEC    INSERTPRODCATA  (   5   ,    100 ,   2   ,   5   );
EXEC    INSERTPRODCATA  (   6   ,    5   ,   1   ,   6   );
EXEC    INSERTPRODCATA  (   7   ,    10  ,   1   ,   7   );

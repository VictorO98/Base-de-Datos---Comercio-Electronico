...
/* 
PARA LLAMAR PAQUETES 

DECLARE
BEGIN
    pk_pedidos.crearpedido(98);
    pk_pedidos.CrearDetallePedido(18,1,150);
END;

*/

create or replace NONEDITIONABLE PACKAGE PK_PEDIDOS IS
...
create or replace NONEDITIONABLE PACKAGE BODY PK_PEDIDOS IS
